...
?>
						...
						<div class="tour_column">
							...
							<p class="tour_info_top">
								<span class="tour_category <?php echo esc_attr( $area->slug ); ?>"><?php echo esc_attr( $area->name ); ?></span>
								<span class="tour_date">設定期間：<?php echo esc_attr( $post->cf_start_day ); ?>&#xFF5E;<?php echo esc_attr( $post->cf_end_day ); ?></span>
							</p>
							<p class="tour_image"><a href="<?php the_permalink(); ?>">
							<?php
